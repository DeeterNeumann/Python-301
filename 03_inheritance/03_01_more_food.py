...
class Seafood(Ingredient):
    """Models the seafood used for cooking"""

    def sear(self):
        print(f"you seared {self.amount} {self.name}.")

    def expire(self):
        print(f"whoaaa...the {self.name} smells quite terrible")
        seafood_expired = "bad " + self.name
